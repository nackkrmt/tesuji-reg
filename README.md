...
| [react-pdf](https://github.com/wojtekmaj/react-pdf) | ^7.7 | ตัวอ่าน PDF กติกาในแอป (pin v7 — pdf.js v3; v5/v10 พังกับ Next 14 webpack) |
...
│  └─ migrations/              # SQL migrations (เช่น ตาราง/RPC โค้ดส่วนลด)
