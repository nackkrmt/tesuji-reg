...
export type AdminNavItem = {
  ...
  exact?: boolean;
  icon: ReactNode;
  /** Rose treatment (รีเซ็ต) in every nav surface. */
  danger?: boolean;
};

/** Back-compat alias — the dock/sheet/shell historically import this name. */
export type AdminTab = AdminNavItem;

export type AdminNavGroup = {
  /** Section header; null = headerless block (ภาพรวม on top, รีเซ็ต at the bottom). */
  title: string | null;
  items: AdminNavItem[];
};
...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    title: "จัดการแข่งขัน",
    items: [
      { href: "/admin/tournaments", label: "ทัวร์นาเมนต์", icon: <AdminNavIcon d="M8 4h8v3a4 4 0 11-8 0V4zM6 5H4v1a3 3 0 003 3M18 5h2v1a3 3 0 01-3 3M9 14h6M12 11v3M9 20h6M10 17h4v3h-4z" /> },
  ...
  },
  {
    title: null,
    items: [
      { href: "/admin/reset", label: "รีเซ็ต", danger: true, icon: <AdminNavIcon d="M10.3 3.9l-8 14A2 2 0 004 21h16a2 2 0 001.7-3l-8-14a2 2 0 00-3.4 0zM12 9v4M12 17h.01" /> },
    ],
  },
];

/** Flat list preserved for the dock's pinned-shortcut lookup and ordering needs. */
export const ADMIN_TABS: AdminNavItem[] = ADMIN_NAV_GROUPS.flatMap((g) => g.items);
