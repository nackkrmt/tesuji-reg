...
- 📖 **อ่านกติกาในแอปได้เลย** — หน้า `/rules` แสดงกฎ กติกาแบบแบ่งหัวข้อ แต่ละหัวข้อมีข้อย่อยใส่เลขข้อให้อัตโนมัติ อ่านง่ายบนมือถือ
...
- 📖 **ตัวสร้างกฎ กติกาแบบแบ่งหัวข้อ** — เพิ่มหัวข้อ (เช่น กติกาการแข่งขัน, การรายงานตัว) แล้วพิมพ์กติกาบรรทัดละข้อ, ย้ายลำดับหัวข้อได้ — แสดงเป็นรายการใส่เลขข้อบนหน้า `/rules`
...
│  ├─ rules.ts                # serialize/parse กฎ กติกาแบบแบ่งหัวข้อ
