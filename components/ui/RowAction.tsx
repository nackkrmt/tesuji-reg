...
export function RowAction({
  ...
  return (
    <button
      type="button"
      className={cn(
        "focus-ring press inline-flex h-10 items-center gap-1.5 rounded-lg px-3.5 text-sm font-medium transition-colors lg:h-8 lg:px-3 lg:text-xs",
        tone === "danger"
          ? "text-rose-300 hover:bg-rose-500/10 hover:text-rose-200"
          : "text-brand-300 hover:bg-brand-500/10 hover:text-brand-200",
        className,
      )}
      {...rest}
    />
...
export const dangerGhost =
  "focus-ring press inline-flex items-center gap-1.5 rounded-lg px-2.5 py-2.5 text-sm font-medium text-rose-300 transition-colors hover:bg-rose-500/10 hover:text-rose-200 lg:py-1.5";
