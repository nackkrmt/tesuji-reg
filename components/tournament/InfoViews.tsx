...
/** The schedule and rules bodies for one tournament. Shared verbatim by the
 *  overview's badge sheets and by the standalone /t/[tid]/schedule|rules pages
 *  — those URLs stay alive because they are what gets pasted into LINE. */
...
export function RulesView({ tournament }: { tournament: Tournament | null }) {
