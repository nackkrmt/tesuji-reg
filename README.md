...
│  └─ migrations/              # SQL migrations (ตาราง/RPC โค้ดส่วนลด + ชุด hardening ก่อน deploy `20260701_*`)
