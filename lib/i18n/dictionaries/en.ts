...
export const en: Dictionary = {
  ...
  home: {
    ...
    noMatch: "No tournaments match your filters",
  ...
  rank: {
    ...
    evidenceYearPromoted: (y: number) => `Promoted in ${y}`,
    evidenceRating: (r: number) => `Rating ${r}`,
    evidenceDiamond: (d: string) => `Diamond ${d}`,
    evidenceKyuPassed: (d: string) => `Passed ${d}`,
  ...
  withdraw: {
    ...
    seatFee: (fee: string) => `Fee ${fee} THB`,
    warningTitle: "Please read before confirming",
    warningBody:
      "Withdrawal takes effect immediately and cannot be undone. The applicant's name is removed from the participant list and the seat is reopened for others. Any refund of the registration fee is at the sole discretion of the organizing team, decided case by case — they reserve the right to refund in full, in part, or not at all. If a refund is approved, it will be transferred to the bank account you provide below.",
    bankInfoHeading: "Refund bank account",
    bankName: "Bank",
    bankNamePlaceholder: "e.g. Kasikornbank",
    accountNo: "Account number",
    accountNoPlaceholder: "Account number for the refund",
    accountName: "Account name",
    accountNamePlaceholder: "Account holder's full name",
    reasonLabel: "Reason for withdrawing",
    reasonPlaceholder: "Optional — a reason helps the team's review",
    confirm: "Confirm withdrawal",
    cancel: "Cancel",
    success:
      "Withdrawn. The team will review the refund and contact you using the bank details you provided.",
    errRequired: "Please fill in all refund bank details",
    errAccountNo: "Invalid account number — digits only (dashes/spaces allowed)",
    errAlready: "This seat has already been withdrawn",
    errGeneric: "Withdrawal failed, please try again",
  },
  swap: {
  ...
  validation: {
    ...
    thaiOnly: "Please enter Thai characters",
    englishOnly: "Please enter English characters",
    phoneRequired: "Please enter a phone number",
    phoneInvalid: "Invalid mobile number (e.g. 0812345678)",
    ...
    instituteRequired: "Please choose or enter an institute",
    pdpaRequired: "Please accept the privacy policy (PDPA)",
    titleCustomRequired: "Please specify the title",
    middleNameRequired: "Please enter the middle name",
  },
  live: {
    metaDescription: "Live Go tournament results — TESUJI Go Competition Organizer",
    backHome: "Home",
    backHomeTitle: "Back to the main site",
    themeToggleTitle: "Toggle light/dark mode",
    badgeSchedule: "Schedule",
    badgeMap: "Map",
    badgeHelp: "Guide",
    ...
    thName: "Name",
    thResult: "Result",
    subFabTitle: "Follow my results",
    subBackTitle: "Back",
    subTitle: "Follow my results 🔔",
    subSearchPlaceholder: "Search names...",
    subStepDivision: "Choose a division",
    histTitle: "Results",
    helpTitle: "How to use",
    helpViewHeading: "View match results",
    helpViewDesc:
      "Tap a division name to see each round’s results. Pick a round from the buttons at the top — results update in real time automatically.",
    helpFollowHeading: "Follow my results",
    helpFollowDesc:
      "Tap the 🔔 button at the bottom right → choose a division → choose your name. Your results card appears at the top, with an alert whenever your result changes.",
    helpScheduleHeading: "Competition schedule",
    helpScheduleDesc:
      "Tap the “📅 Schedule” button above to see every division’s timetable, with live status: playing / finished / up next.",
    helpMapHeading: "Venue map",
    helpMapDesc:
      "Tap the “🗺️ Map” button above to see the table layout and points of interest. Drag to pan, pinch to zoom to find your table.",
    helpHistoryHeading: "View round history",
    helpHistoryDesc:
      "Once you follow someone, an “All rounds” button appears on the card — tap it to browse every past round’s result.",
    helpDismiss: "Got it!",
    scheduleModalTitle: "📅 Competition schedule",
    mapTitle: "🗺️ Venue map",
    mapCloseTitle: "Close",
    mapAlt: "Venue map",
