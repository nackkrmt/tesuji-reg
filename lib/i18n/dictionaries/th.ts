...
export const th = {
  ...
  swap: {
    ...
    intro: "เลือกผู้เข้าแข่งขันคนใหม่สำหรับที่นั่งนี้",
    pickPerson: "เลือกผู้เข้าแข่งขันคนใหม่",
    pickDivision: "รุ่นที่ลงแข่ง",
    self: "ตัวฉัน",
    meTag: "ฉัน",
    addPlayer: "+ เพิ่มผู้เล่นใหม่",
    feeNote: (fee: string) =>
      `เปลี่ยนได้เฉพาะรุ่นที่ค่าสมัคร ${fee} บาท เท่าเดิม (ไม่มีการเก็บเงินเพิ่มหรือคืนเงิน)`,
    noEligible: "ไม่มีรุ่นค่าสมัครเท่าเดิมที่ผู้เล่นคนนี้มีสิทธิ์ลง",
    confirm: "ยืนยันเปลี่ยนคน",
    cancel: "ยกเลิก",
    success: "เปลี่ยนคนเข้าแข่งขันเรียบร้อยแล้ว",
    errFeeMismatch: "รุ่นที่เลือกมีค่าสมัครไม่เท่ากับที่ชำระไว้",
    errClosed: "ปิดรับสมัครแล้ว จึงไม่สามารถเปลี่ยนคนได้",
    errSamePerson: "เป็นผู้เข้าแข่งขันคนเดิมและรุ่นเดิมอยู่แล้ว",
    errAlready: "ที่นั่งนี้ถูกถอนตัวไปแล้ว",
